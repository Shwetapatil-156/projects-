...
#client = MongoClient(config['mongodb://localhost:27017/'])
client = MongoClient("mongodb+srv://shwetapatil:shweta19@cluster0.xxd0hpa.mongodb.net/?retryWrites=true&w=majority", tlsCAFile=ca)
db = client.test
